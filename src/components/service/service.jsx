...
const Service = () => {
  return (
    <div className='flex relative justify-center items-center flex-wrap gap-20 pt-10 bg-slate-200'>
      <div>
        <h1 className='w-full text-center text-5xl font-bold text-gray-500'>RAQAM TANLASH</h1>
      ...
      <div className='w-full flex justify-center items-center gap-4'>
        <div className='w-[200px]'>
          <div className='p-2'>
          <a href="https://ucell.uz/uz/subscribers/services2/subscribers_services/chosen_number"><img src={Ucell} alt="Ucell" className='w-[220px] rounded-3xl h-[150PX]' /></a>
          </div>
        ...
        <div className='w-[200px]'>
          ...
          <a href="https://nomer.beeline.uz/uz/sim"><img src={Beeline} alt="Beeline" className='w-[220px] rounded-3xl h-[150PX]' /></a>
          </div>
          <div className='w-[200px] flex justify-center items-center flex-wrap gap-2'>
        ...
        <div className='w-[220px]'>
          <div className='p-2'>
          <a href="https://raqamtanlash.uz/mobiuz/pick-number"><img src={Mobi} alt="Mobi " className='w-[200px] rounded-3xl h-[150PX]' /></a>
          </div>
        ...
        <div className='w-[220px]'>
          <div className='p-2'>
          <a href="https://uztelecom.uz/uz/jismoniy-shaxslarga/mobil-raqamlarni-onlayn-band-qilish/"><img src={Uzmobile} alt="Uzmobile" className='w-[250px] rounded-3xl h-[150PX]' /></a>
          </div>
